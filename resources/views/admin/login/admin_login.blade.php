            ...
            <div class="card-body">
              ...
              <h4 class="mb-2">
                 <?php
                            ...
                            ?></h4>
              <p>Cần đăng nhập để vào quản lý</p>

              <form id="formAuthentication" class="mb-3" action="{{url('/admin-dashboard')}}" method="POST">
              {{ csrf_field() }}
                <div class="mb-3">
              ...
              <p class="text-center">
                <span>Bạn đã có tài khoảng chưa?</span>
                <a href="{{url('/register-admin')}}">
                  <span>Tạo tài khoảng </span>
                </a>
              </p>
            </div>
          </div>
