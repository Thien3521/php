...
>
  <head>
    ...
    <title>Đăng nhập - Trang | Quản lý - Gym</title>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="{{ asset('public/login/admin/assets/vendor/css/pages/page-auth.css') }}" />
    <!-- Helpers -->
        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              <!-- Logo -->
              <center>
              <img algin = "center" width = "150px;" src="{{ asset('public/uploads/avatar.jpg') }}" alt="">
              </center>
              ...
              <h4 class="mb-2">
                 <?php
                            $message = Session::put('message', 'Bạn đã nhập sai mật khẩu hoặc tài khoản.');
                            if($message){
              ...
              <form id="formAuthentication" class="mb-3" action="{{url('/save-admin-register')}}" method="POST">
              {{ csrf_field() }}
              <div class="mb-3">
                  <label for="email" class="form-label">Tên của bạn</label>
                  <input
                    type="text"
                    class="form-control"
                    id="admin_name"
                ...
                <div class="mb-3">
                  <div class="form-check">
                    ...
                    <label class="form-check-label" for="remember-me"> Lưu tài khoảng </label>
                  </div>
                </div>
                <div class="mb-3">
